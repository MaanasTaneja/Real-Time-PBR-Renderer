...
public:
	...
	void addSkybox(unsigned int cubes) 
	{
		skybox->setCubeMap(cubes);
	}
	...
	void setupShaderUniforms(glm::mat4 projection_, glm::mat4 view_) //temp to be shifted to masterrednerer
	{
		...
		skyboxShader->use();
		skyboxShader->setMat4("projection", glm::mat4(projection_));
		skyboxShader->setMat4("view", glm::mat4(view_));
	...
	void renderSkybox(glm::mat4 proj, glm::mat4 view, Camera cam3)
	{
		view = glm::mat4(glm::mat3(cam3.GetViewMatrix()));
		...
		glBindTexture(GL_TEXTURE_CUBE_MAP, skybox->hdrTexture);
